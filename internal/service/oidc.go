...
func fetchOIDCUserInfoClaims(ctx context.Context, provider *oidc.Provider, oauthToken *oauth2.Token, userInfoEndpoint string, client *http.Client) (*oidcIdentityClaims, error) {
