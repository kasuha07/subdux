...
func (s *Service) buildTemplateData(
	candidate subscriptionservice.ReminderCandidate,
	user *model.User,
) TemplateData {
...
func (s *Service) renderNotificationMessage(userID uint, channelType string, templateData TemplateData) (string, error) {
