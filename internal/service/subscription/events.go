...
func (s *Service) recordSubscriptionCreated(userID uint, sub model.Subscription) error {
...
func (s *Service) recordSubscriptionDeleted(userID uint, sub model.Subscription) error {
	snapshot, err := s.buildSubscriptionEventSnapshot(userID, sub)
	if err != nil {
		return err
	}
...
func (s *Service) buildSubscriptionEventSnapshot(userID uint, sub model.Subscription) (subscriptionEventSnapshot, error) {
