...
func TestListSubscriptionReminderCandidatesCreatesExpectedTriggerCandidates(t *testing.T) {
	...
	assertCandidate("Due today", TriggerDueDay, "auto_renew_reminder", "2026-03-10", 0)
	assertCandidate("Three days out", TriggerDaysBefore, "auto_renew_reminder", "2026-03-13", 3)
	assertCandidate("Manual daily", TriggerManualDaily, "manual_renew_reminder", "2026-03-12", 2)
	assertCandidate("Ending soon", TriggerEndingSoon, "ending_soon", "2026-03-13", 3)
