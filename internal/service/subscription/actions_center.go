...
func (s *Service) GetActionCenter(userID uint) (*ActionCenter, error) {
...
func (s *Service) SnoozeAction(userID uint, input SnoozeSubscriptionActionInput) (*model.SubscriptionActionSnooze, error) {
...
func (s *Service) activeActionSnoozes(userID uint, today time.Time) (map[string]model.SubscriptionActionSnooze, error) {
...
func (s *Service) notificationFailureActions(userID uint, today time.Time) ([]SubscriptionAction, error) {
...
func (s *Service) notificationRecoveryIndex(userID uint, since time.Time) (func(model.NotificationLog) bool, error) {
