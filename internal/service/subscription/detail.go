...
func (s *Service) GetDetail(userID, id uint) (*SubscriptionDetail, error) {
...
func (s *Service) subscriptionDetailTimeline(userID, subscriptionID uint) ([]SubscriptionDetailEvent, error) {
...
func (s *Service) subscriptionDetailNotificationLogs(userID, subscriptionID uint) ([]SubscriptionDetailNotificationLog, error) {
