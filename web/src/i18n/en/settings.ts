const settings = {
  ...
  "account": {
    ...
    "emailChangeReauthTitle": "Re-authenticate to change email",
    "emailChangeReauthDescription": "Verify your identity before confirming your new email address.",
    ...
    "logoutAllDescription": "Revoke all of your other login sessions and sign out this device as well.",
    "logoutAllSuccess": "Signed out on all devices",
    "logoutSuccess": "Logged out successfully",
    "exportTitle": "Data Export",
    "exportDescription": "Download your data as JSON. Notification secrets are redacted by default.",
    "exportButton": "Export redacted data",
    "exportFailed": "Export failed",
    "exporting": "Exporting...",
    "exportWithSecretsButton": "Include secrets",
    "exportWithSecretsConfirmTitle": "Export notification secrets",
    "exportWithSecretsConfirmDescription": "This file will include SMTP passwords, webhook secrets, bot tokens, and other notification credentials. Store it securely and delete it when you no longer need it.",
    "exportWithSecretsConfirmButton": "Export with secrets",
    "exportWithSecretsCancelButton": "Cancel",
    "exportReauthTitle": "Re-authenticate to export",
    "exportReauthDescription": "Verify your identity before exporting redacted account data.",
    "exportSecretsReauthDescription": "Verify your identity before exporting account data that includes notification secrets.",
    "subduxImportTitle": "Import my data",
    "subduxImportDescription": "Import from a Subdux export file (currencies, categories, payment methods, subscriptions, preferences, and notifications)",
    "subduxImportButton": "Import Subdux export",
    "subduxImportAnalyzing": "Analyzing export...",
    "subduxImporting": "Importing...",
    "subduxImportSuccess": "Import completed: {{imported}} changes applied ({{skipped}} skipped)",
    "subduxImportFailed": "Failed to import Subdux export",
    "subduxImportInvalidFormat": "Invalid file format. Please select a valid Subdux export JSON file",
    ...
    "subduxImportTemplates": "Notification templates",
    "subduxImportWillUpdate": "Will update",
    "subduxImportUnchanged": "Unchanged",
  ...
  "about": {
    "title": "About",
    "description": "Application information and resources",
    ...
    "feedbackDescription": "Report bugs or request features on GitHub",
    "openIssue": "Open an Issue",
    "sourceCode": "Source Code",
    "sourceCodeDescription": "View the source code on GitHub",
    "license": "License",
    "acknowledgments": "Acknowledgments",
    "acknowledgmentsDescription": "Subdux is built with the following open-source technologies",
    "backendTech": "Backend",
    "frontendTech": "Frontend"
  },
  "apiKeys": {
    "title": "API Keys",
    "description": "Create API keys for external programs to access your data",
    "create": "Create API Key",
    "creating": "Creating...",
    "name": "Name",
    "namePlaceholder": "e.g. My Script",
    ...
    "delete": "Delete",
    "deleting": "Deleting...",
    "deleteConfirm": "Are you sure you want to delete this API key? Any applications using it will lose access.",
