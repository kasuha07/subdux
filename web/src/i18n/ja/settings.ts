const settings = {
  ...
  "account": {
    ...
    "emailChangeReauthTitle": "メール変更前に再認証",
    "emailChangeReauthDescription": "新しいメールアドレスを確定する前に本人確認を行ってください。",
    ...
    "logoutAll": "すべての端末からサインアウト",
    "logoutAllDescription": "他のすべてのログインセッションを無効化し、この端末からもサインアウトします。",
    "logoutAllSuccess": "すべての端末からサインアウトしました",
    "logoutSuccess": "サインアウトしました",
    "exportTitle": "データエクスポート",
    "exportDescription": "データを JSON ファイルとしてダウンロードします。通知シークレットはデフォルトで伏せられます。",
    "exportButton": "伏せ字でエクスポート",
    "exportFailed": "エクスポートに失敗しました",
    "exporting": "エクスポート中...",
    "exportWithSecretsButton": "シークレットを含める",
    "exportWithSecretsConfirmTitle": "通知シークレットをエクスポート",
    "exportWithSecretsConfirmDescription": "このファイルには SMTP パスワード、Webhook シークレット、bot トークン、その他の通知認証情報が含まれます。安全に保管し、不要になったら削除してください。",
    "exportWithSecretsConfirmButton": "シークレット付きでエクスポート",
    "exportWithSecretsCancelButton": "キャンセル",
    "exportReauthTitle": "エクスポート前に再認証",
    "exportReauthDescription": "伏せ字のアカウントデータをエクスポートする前に本人確認を行ってください。",
    "exportSecretsReauthDescription": "通知シークレットを含むアカウントデータをエクスポートする前に本人確認を行ってください。",
